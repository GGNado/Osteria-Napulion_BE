package com.giggi.osterianapulion_be.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleReservationUnavailableException(ReservationUnavailableException ex) {
        Map<String, Object> body = new HashMap<>();
        body.put("timestamp", LocalDateTime.now());
        body.put("status", HttpStatus.CONFLICT.value());
        body.put("error", "Conflict");
        body.put("message", ex.getMessage());
        body.put("path", "/api/prenotazioni");
        return new ResponseEntity<>(body, HttpStatus.CONFLICT);
    }
    ...
    public ResponseEntity<Object> handleRateLimiterException(RateLimiterException ex) {
        Map<String, Object> body = new HashMap<>();
        body.put("timestamp", LocalDateTime.now());
